...
fn Exercise() -> impl IntoView {
    // TODO: 使用 signal() 创建在线状态信号，初始值为 true
    // let (is_online, set_online) = signal(true);

    // TODO: 使用 window_event_listener 监听 online 事件
    // 提示: window_event_listener(ev::online, move || set_online.set(true));

    // TODO: 使用 window_event_listener 监听 offline 事件

    view! {
        <div style="max-width: 600px; margin: 2rem auto; font-family: sans-serif;">
            <h1>"🌐 网络状态检测"</h1>

            // TODO: 根据 is_online 的值显示不同横幅
            // 在线: 绿色背景 "✅ 您当前处于在线状态"
            // 离线: 红色背景 "❌ 您当前处于离线状态 - 显示缓存数据"
