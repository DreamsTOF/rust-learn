// ============================================================
// 练习 154: use_clipboard — 剪贴板读写封装
//
// 目标: 封装浏览器 Clipboard API，提供读/写剪贴板的 hook
//
// 难度: ⭐⭐⭐
// 核心知识点: 剪贴板 API、wasm_bindgen、异步边界
//
// TODO: 按照注释提示补全代码
// ============================================================
...
extern "C" {
    ...
    // 访问 window.navigator.clipboard 链的自定义类型
    type JsWin;
