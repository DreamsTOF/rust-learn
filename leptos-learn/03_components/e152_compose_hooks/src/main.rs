// ============================================================
// 练习 152: compose_hooks — use_counter + use_local_storage 组合
//
// 目标: 实现 use_counter 和 use_local_storage 两个 hook，并将它们
//       组合使用，使计数器状态持久化到 localStorage。
//
// 难度: ⭐⭐⭐
// 核心知识点: 组合多个 Hook、localStorage 读写、状态持久化
//
// TODO: 按照注释提示补全代码
// ============================================================
