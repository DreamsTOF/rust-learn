// ============================================================
// 练习 218: nested_breadcrumb — 基于路由树的面包屑导航
//
// 目标: 使用 use_location() 获取当前路径，分割路径段构建面包屑链接
//
// 难度: ⭐⭐⭐
// 核心知识点: use_location(), 动态面包屑
//
// TODO: 按照注释提示补全代码
// ============================================================
...
// === 步骤 1 ——————————————————————————————————————————
// TODO: BreadcrumbLayout 布局组件
// 提示: 使用 use_location() 构建动态面包屑导航，每个片段是可点击链接
#[component]
...
// TODO: ProductCategory 组件 — 从 URL 中获取分类名并显示
#[component]
...
fn main() {
    mount_to_body(|| view! {
        // TODO: 配置路由器，使用 ParentRoute 共享面包屑布局
        <Router>
            <main>
